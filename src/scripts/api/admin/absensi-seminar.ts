...
// Halaman Absensi Seminar (admin) — dibuka dari tombol "Absensi" di Jadwal
// Seminar admin (?seminar_id=...). Menampilkan info seminar + daftar
// peserta forum (kartu seminar) yang statusparaf-nya bisa ditandai
...
// seminar dari seminar manapun (tidak dibatasi moderator_id).
//
...
// (KartuSeminarController::bulkUpdateStatusParaf) tetap memakai tanda
...
// Perubahan lokal yang belum disimpan: id kartu seminar -> status pilihan admin
