// src/scripts/api/biodata-mahasiswa-api.ts
// GET & PATCH & POST(store) untuk halaman biodata mahasiswa.
// - GET  /auth/profile              -> isi nama, NIM, email, foto, preview tandatangan
// - PATCH /auth/profile             -> simpan email (nama & NIM readonly, tidak dikirim)
