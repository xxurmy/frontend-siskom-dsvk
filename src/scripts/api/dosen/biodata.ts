// src/scripts/api/dosen/biodata.ts
// GET & PATCH untuk halaman biodata dosen.
// - GET   /auth/profile -> isi nama (readonly), NIP (readonly), email
// - PATCH /auth/profile -> simpan email saja (nama & NIP tidak dikirim)
//
