...
//
// TAMPILAN KOLOM (disamakan dengan pola tabel kartu-kolokium dosen):
...
// tabel kartu-kolokium.
// ------------------------------------------------------------------
function renderPemrasaranCell(item: KartuSeminar): string {
...
// ------------------------------------------------------------------
function renderForumCell(item: KartuSeminar): string {
