...
// Halaman Absensi Kolokium — dibuka dari tombol "Absensi" di Jadwal Kolokium
// dosen (?kolokium_id=...). Menampilkan info kolokium + daftar peserta forum
// (kartu kolokium) yang statusparaf-nya bisa ditandai Hadir/Tidak Hadir,
...
//
// Aturan tombol aksi sama dengan halaman Kartu Kolokium:
...
// Perubahan lokal yang belum disimpan: id kartu kolokium -> status pilihan dosen
